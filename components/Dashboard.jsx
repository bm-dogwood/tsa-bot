  ...
  return (
    <section id="dashboard" className="py-24 bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block mb-4 px-4 py-1.5 rounded-full bg-white/10 text-white text-sm border border-white/20">
            Live Demo
          </span>
          ...
          <div className="bg-slate-900 rounded-2xl border border-white/10 p-6 md:p-8 shadow-2xl">
            ...
            <div className="flex flex-wrap justify-between gap-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/40 text-sm">• Checkpoint 14A</span>
              </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                  ...
                  <div className="relative aspect-video bg-black/40 rounded-lg mb-4 flex items-center justify-center">
                    <div className="w-48 h-32 bg-white/5 rounded border border-white/10 relative overflow-hidden">
                      <div className="absolute inset-x-0 h-1 bg-gradient-to-b from-yellow-400 to-transparent animate-pulse" />
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                  ...
                  <div className="flex items-end gap-2 mb-3">
                    ...
                    <span className="text-white/40 text-sm">Low Risk</span>
                  </div>
                ...
                {/* Confidence */}
                <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                  <p className="text-white/60 text-sm mb-2">Model Confidence</p>
                ...
                <div className="bg-emerald-500/10 rounded-xl p-6 border border-emerald-500/30">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-white">AI Recommendation</h4>
                  </div>
                ...
                <div className="space-y-2">
                  <button className="w-full flex items-center gap-2 px-4 py-2 rounded-md bg-white/10 hover:bg-white/20 text-white text-sm">
                ...
                <div className="bg-white/5 rounded-xl p-4 border border-white/10 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white/60 text-sm">Active Scans</span>
                  </div>
